  ...
  comments: [
    {
      ...
      downvoteCount: 0,
      userVoteType: 'UP',
      upvoters: ['Alex Morgan', 'Jane Smith', 'John Doe'],
      downvoters: [],
    },
    {
      id: '2',
      ...
      userVoteType: null,
      upvoters: ['John Doe'],
      downvoters: ['Alex Morgan', 'Greg Miller'],
    },
  ],
};
    ...
    caseData: {
      ...
      comments: [
        ...
        },
        {
          ...
          downvoteCount: 1,
          userVoteType: null,
          upvoters: ['Alex Morgan', 'Jane Smith', 'Greg Miller', 'Andrew Smith', 'Sarah Johnson'],
          downvoters: ['Mike Brown'],
        },
        {
          id: '5',
